        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    ...
                    <h5 className='font-medium text-sm'>{Math.round(props.distance) + 4} mins away </h5>
            ...
            <div onClick={() => {
                ...
                <div className='-ml-2 w-1/2'>
                    ...
                    <h5 className='font-medium text-sm'>{Math.round(props.distance)} mins away </h5>
            ...
            <div onClick={() => {
                ...
                <div className='ml-2 w-1/2'>
                    ...
                    <h5 className='font-medium text-sm'>{Math.round(props.distance) + 2} mins away </h5>
